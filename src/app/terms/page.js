              ...
              <div className="card shadow border-0 rounded">
                <div className="card-body">
                  ...
                  <p className="text-muted">
                    ...
                    said to have <b className="text-danger">originated</b> in
                    the 16th century. Lorem Ipsum is{" "}
                    <b className="text-danger">composed</b> in a pseudo-Latin
                    language which more or less{" "}
                    <b className="text-danger">corresponds</b> to proper Latin.
                    It contains a series of real Latin words. This ancient dummy
                    text is also <b className="text-danger">incomprehensible</b>
                    , but it imitates the rhythm of most European languages in
                    Latin script. The <b className="text-danger">advantage</b>{" "}
                    of its Latin origin and the relative{" "}
                    <b className="text-danger">meaninglessness</b> of Lorum
                    Ipsum is that the text does not attract attention to itself
                    or distract the viewers{" "}
                  ...
                  <div className="mt-3">
                    <Link href="" className="btn btn-primary mt-2 me-2">
                      Accept
                    </Link>
