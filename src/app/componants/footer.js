            ...
            <div className="row align-items-end">
              ...
              <div className="col-md-5 mt-4 mt-sm-0">
                <div className="text-md-end ms-5 ms-sm-0">
                  <Link href="/job-apply" className="btn btn-primary me-1 my-1">
                    Apply Now
                  </Link>
                  <Link href="/contactus" className="btn btn-soft-primary my-1">
                    Contact Us
                  </Link>
                </div>
              </div>
                ...
                <div className="col-sm-9 mt-4 mt-sm-0">
                  <ul className="list-unstyled footer-list terms-service text-center text-sm-end mb-0">
                    <li className="list-inline-item my-2">
                      <Link href="/" className="text-foot fs-6 fw-medium me-2">
            ...
            <div className="col-sm-6">
              <div className="text-sm-start">
                <p className="mb-0 fw-medium">
                  Copyright © {new Date().getFullYear()} WorkHub. All Rights
                  Reserved
                </p>
              </div>
            </div>
