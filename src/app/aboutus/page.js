          ...
          <div className="row justify-content-center mb-4 pb-2">
            <div className="col-12">
              <div className="section-title text-center">
                <h4 className="title mb-3">Heres why youll love it WorkHub</h4>
            ...
            <div className="col-md-6 col-12">
              <div className="d-flex">
                ...
                <div className="flex-1">
                  <h5 className="mt-0">
                    How our <span className="text-primary">WorkHub</span> work ?
                  </h5>
            ...
            <div className="col-md-6 col-12 mt-4 pt-2">
              <div className="d-flex">
                ...
                <div className="flex-1">
                  <h5 className="mt-0">
                    {" "}
                    Is <span className="text-primary">WorkHub</span> safer to
                    use with my account ?
                  </h5>
                  <p className="answer text-muted mb-0">
            ...
            <div className="col-12 text-center">
              <div className="section-title">
                ...
                <p className="text-muted para-desc mx-auto">
                  Start working with{" "}
                  <span className="text-primary fw-bold">WorkHub</span> that can
