...
export default function CandidateProfile(props) {
  let data = candidatesData.find(
    (candidates) => candidates.id === parseInt(props.params.id)
  );
  return (
    <>
          ...
          <div className="row g-4">
            <div className="col-lg-8 col-md-7 col-12">
              ...
              <p className="text-muted">
                Obviously IM Web Developer. Web Developer with over 3 years of
              ...
              <div className="card bg-light p-4 rounded shadow sticky-bar">
                ...
                <div className="mt-3">
                  ...
                  <div className="p-3 rounded shadow bg-white mt-2">
                    ...
                    <Link
                      href="/images/calvin-carlo-resume.pdf"
                      download="pdf"
                      target="_blank"
                ...
                >
                  <div className="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                    <div className="content">
                      ...
                      <div className="mt-3">
                        <Link
                          href={`/candidate-profile/${item.id}`}
